...
public class StringQuiz02 {
	public static void main(String[] args) {
		try {
			...
			System.out.println(masking("950101200000"));
			System.out.println(masking("950101-500000"));
			System.out.println(masking("950101500000"));
			System.out.println(masking("95010151111"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
		 ...
		 * 마스킹 메서드는 주민번호값이 매개변수로 들어 올 대
		 * 950101-*******로 마스킹 처리하여 리턴하는 static메서드를 만들어주세요
		 * 
		 * 조건
		 * 1.문제의 간소화를 위해 생년월일은 정상범위위라고 가정합니다
		 * 2.13자리가 아니거나,남,여 가 아니라면 throws처리합니다
		 * 3.주민번호 - 를 포함해서 받을 수 있습니다
		 * 4.남 여에 대한 정보를 출력해줍니다
		 * 
		 * 마스킹메서드를 만들엊세요
		 * 검증데이터 950101 - 1000000 남자
		 * 950101 200000  여자
		 * 검증데이터 950101-500000예외
		 * 검증데이터 950101500000 예외
		 * 950101 51111 예외
		 */
